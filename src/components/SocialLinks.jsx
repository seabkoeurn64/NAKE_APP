    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
      {socials.map((social, index) => (
        <a
          ...
          className={`group relative bg-white/5 rounded-2xl p-4 border border-white/10 backdrop-blur-sm transition-all duration-500 hover:scale-105 hover:border-white/20 ${social.bgColor}`}
          data-aos="fade-up"
        ...
        >
          ...
          {/* Icon */}
          <div className={`relative z-10 bg-gradient-to-br ${social.color} p-3 rounded-xl mb-3 group-hover:shadow-lg transition-all duration-300 group-hover:scale-110 mx-auto w-14 h-14 flex items-center justify-center`}>
            {social.icon}
          </div>
